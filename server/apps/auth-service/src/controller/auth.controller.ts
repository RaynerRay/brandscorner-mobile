...
export const loginUser = async (
  ...
  try {
    ...
    // Fetch user with avatar relation
  ...
  try {
    ...
    await prisma.notifications.create({
      data: {
        ...
        creatorId: userId,
        receiverId: userId,
        redirect_link: `https://eshop.com/my-profile?active=profile`,
        type: "system",
      },
    });
  ...
  try {
    ...
    await prisma.notifications.create({
      data: {
        ...
        creatorId: userId,
        receiverId: userId,
        redirect_link: `https://eshop.com/account`,
        type: "account",
        data: {
          label,
        },
...
export const setDefaultAddress = async (
  ...
  try {
    ...
    await prisma.notifications.create({
      data: {
        title: `Default Address Update`,
        message: `Your default address has been updated.`,
        creatorId: userId,
        receiverId: userId,
        redirect_link: `https://eshop.com/my-profile?active=shipping+Address`,
        type: "system",
      },
    });
...
export const updateUserAvatar = async (
  ...
  try {
    ...
    // First, check if image with this file_id already exists
    ...
    // Then update the user's avatar relation
...
export const addingUserActivities = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    await producer.send({
      topic: "user-events",
      messages: [{ value: JSON.stringify(req.body.eventData) }],
    });
  } catch (error) {
    next(error);
  }
